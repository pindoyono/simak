        ...
        @if ($stats['total'] > 0)
            ...
            <div class="fi-section rounded-xl bg-white p-6 shadow-sm ring-1 ring-gray-950/5">
                ...
                <div class="grid grid-cols-2 gap-4 md:grid-cols-5">
                    <!-- Sangat Baik (4) -->
                    <div
                        class="rounded-lg border border-success-200 bg-success-50 p-4 text-center transition-colors hover:bg-success-100">
                    ...
                    <!-- Baik (3) -->
                    <div
                        class="rounded-lg border border-info-200 bg-info-50 p-4 text-center transition-colors hover:bg-info-100">
                    ...
                    <!-- Cukup (2) -->
                    <div
                        class="rounded-lg border border-warning-200 bg-warning-50 p-4 text-center transition-colors hover:bg-warning-100">
                    ...
                    <!-- Kurang (1) -->
                    <div
                        class="rounded-lg border border-danger-200 bg-danger-50 p-4 text-center transition-colors hover:bg-danger-100">
                    ...
                    <!-- Tidak Ada (0) -->
                    <div
                        class="rounded-lg border border-gray-200 bg-gray-50 p-4 text-center transition-colors hover:bg-gray-100">
        ...
        @else
            ...
            <div class="fi-section rounded-xl bg-white p-12 text-center shadow-sm ring-1 ring-gray-950/5">
                ...
                <p class="mx-auto mt-2 max-w-sm text-sm text-gray-500">
                    Pilih filter di atas untuk melihat data penilaian atau tunggu hingga ada data penilaian yang
                    tersedia.
                </p>
            </div>
        @endif
