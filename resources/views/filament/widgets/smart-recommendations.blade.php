        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <div class="bg-gradient-to-r from-red-50 to-red-100 dark:from-red-900/20 dark:to-red-800/20 p-4 rounded-lg border border-red-200 dark:border-red-800">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-red-700 dark:text-red-300">{{ $stats['urgent_actions'] }}</div>
            ...
            <div class="bg-gradient-to-r from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-green-700 dark:text-green-300">{{ $stats['quick_wins'] }}</div>
            ...
            <div class="bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-blue-700 dark:text-blue-300">{{ $stats['estimated_impact'] }}</div>
            ...
            <div class="bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-2xl font-bold text-purple-700 dark:text-purple-300">{{ $stats['implementation_timeline'] }}</div>
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-6 hover:shadow-lg transition-shadow">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-start">
                                ...
                                @endif
                                <div>
                                    <h4 class="text-lg font-medium text-gray-900 dark:text-white">{{ $recommendation['title'] }}</h4>
                        ...
                        @if(isset($recommendation['school']))
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 mb-4">
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h5 class="font-medium text-gray-900 dark:text-white">{{ $recommendation['school']->name }}</h5>
                        ...
                        <!-- Actions -->
                        <div class="mb-4">
                            <h6 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Recommended Actions:</h6>
                            <ul class="space-y-2">
                        ...
                        <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
                            <div class="flex items-start">
                                ...
                                <div>
                                    <h6 class="text-sm font-medium text-green-800 dark:text-green-200">Expected Outcome</h6>
                                    <p class="text-sm text-green-700 dark:text-green-300">{{ $recommendation['expected_outcome'] }}</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        ...
                        @if(isset($suggestion['expected_time_savings']))
                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 mb-3">
                                <div class="text-sm">
                                    ...
                                    <span class="text-green-700 dark:text-green-300 ml-1">{{ $suggestion['expected_time_savings'] }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        @if(isset($suggestion['expected_efficiency_gain']))
                            <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-3 mb-3">
                                <div class="text-sm">
                                    ...
                                    <span class="text-blue-700 dark:text-blue-300 ml-1">{{ $suggestion['expected_efficiency_gain'] }}</span>
                                </div>
                            </div>
                        @endif
                        ...
                        @if(isset($suggestion['expected_quality_improvement']))
                            <div class="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg p-3 mb-3">
                                <div class="text-sm">
                                    <span class="font-medium text-purple-800 dark:text-purple-200">Quality Improvement:</span>
                                    <span class="text-purple-700 dark:text-purple-300 ml-1">{{ $suggestion['expected_quality_improvement'] }}</span>
                                </div>
                            </div>
                        @endif
                        
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-3">
                            <h6 class="text-xs font-medium text-gray-700 dark:text-gray-300 mb-2">Implementation Steps:</h6>
                            <ol class="text-xs space-y-1">
                                @foreach($suggestion['steps'] as $index => $step)
                                    <li class="flex items-start">
                                        <span class="bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200 rounded-full w-4 h-4 flex items-center justify-center text-xs font-medium mr-2 mt-0.5">
                                            {{ $index + 1 }}
                                        </span>
                            ...
                            @if($practice['type'] === 'school_excellence' && isset($practice['school']))
                                <div class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-3">
                                    <div class="grid grid-cols-2 gap-4 text-sm">
                                        <div>
                                            <span class="font-medium text-yellow-800 dark:text-yellow-200">School:</span>
                                            <span class="text-yellow-700 dark:text-yellow-300 ml-1">{{ $practice['school']->name }}</span>
                                        </div>
                                        <div>
                                            <span class="font-medium text-yellow-800 dark:text-yellow-200">Applicable to:</span>
                                            <span class="text-yellow-700 dark:text-yellow-300 ml-1">{{ $practice['applicable_to'] }} similar schools</span>
                                        </div>
                                    </div>
                                </div>
                            @endif
