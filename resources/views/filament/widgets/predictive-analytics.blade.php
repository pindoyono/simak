                            ...
                            <div class="flex justify-between items-start mb-2">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 dark:text-gray-400">
                                        {{ $prediction['school']->type }} • {{ $prediction['school']->region ?? 'Unknown Region' }}
                                    </p>
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="font-medium ml-1
                                        ...
                                        @if($prediction['trend'] > 0) ↗️
                                        @elseif($prediction['trend'] < 0) ↘️
                                        @else ➡️ @endif
                                    </span>
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                @foreach($recommendations as $recommendation)
                    <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
                        ...
                        <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700 flex justify-between text-xs">
                            <span class="text-gray-500 dark:text-gray-400">
                                Impact: <span class="font-medium">{{ ucfirst($recommendation['expected_impact']) }}</span>
                            </span>
                            <span class="text-gray-500 dark:text-gray-400">
                        ...
                        <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                ...
                                <div>
                                    ...
                                    <span class="text-gray-600 dark:text-gray-400 ml-1">{{ $risk['mitigation'] }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
