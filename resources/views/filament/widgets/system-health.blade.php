                ...
                <div class="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-800">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-semibold text-blue-900 dark:text-blue-100">{{ $metrics['schools'] }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-blue-700 dark:text-blue-300">Active Assessors</span>
                            <span class="text-sm font-semibold text-blue-900 dark:text-blue-100">{{ $metrics['assessors'] }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-blue-700 dark:text-blue-300">Pending Reviews</span>
                            <span class="text-sm font-semibold text-blue-900 dark:text-blue-100">{{ $metrics['pending'] }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg p-4 border border-green-200 dark:border-green-800">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-semibold text-green-900 dark:text-green-100">{{ $performance['response_time'] }}ms</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-green-700 dark:text-green-300">System Load</span>
                            <span class="text-sm font-semibold text-green-900 dark:text-green-100">{{ $performance['system_load'] }}</span>
                        </div>
                        <div class="flex justify-between">
                ...
                <div class="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-800">
                    ...
                    <div class="space-y-2">
                        <div class="flex justify-between">
                            ...
                            <span class="text-sm font-semibold text-purple-900 dark:text-purple-100">{{ $quality['completion_rate'] }}%</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-purple-700 dark:text-purple-300">Avg Score</span>
                            <span class="text-sm font-semibold text-purple-900 dark:text-purple-100">{{ number_format($quality['average_score'], 2) }}</span>
                        </div>
                        <div class="flex justify-between">
                            <span class="text-sm text-purple-700 dark:text-purple-300">Error Rate</span>
                            <span class="text-sm font-semibold text-purple-900 dark:text-purple-100">{{ $quality['error_rate'] }}%</span>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            @if($currentPeriod->tanggal_selesai)
                                <span class="text-primary-600 dark:text-primary-400">
                                    <strong>Ends:</strong> {{ \Carbon\Carbon::parse($currentPeriod->tanggal_selesai)->format('M d, Y') }}
                                </span>
                            @endif
                        </div>
